...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__14351E4",
    appName: "photo-parameter-border",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
let targetHost = "";
const hosts = "192.168.56.1,192.168.123.115".split(",");
setTimeout(() => {
  index.request({
...
(function(module2, exports2) {
  (function() {
    ...
    var EXIF2 = function(obj) {
      if (obj instanceof EXIF2)
        return obj;
      if (!(this instanceof EXIF2))
        return new EXIF2(obj);
      this.EXIFwrapped = obj;
    };
    {
      if (module2.exports) {
        exports2 = module2.exports = EXIF2;
      }
      exports2.EXIF = EXIF2;
    }
      ...
      if (img.src) {
        if (/^data\:/i.test(img.src)) {
          ...
          fileReader.onload = function(e2) {
            handleBinaryFile(e2.target.result);
          };
    ...
    function getStringFromDB(buffer2, start, length) {
      var outstr = "";
      for (n = start; n < start + length; n++) {
        outstr += String.fromCharCode(buffer2.getUint8(n));
      }
      return outstr;
    }
...
var exifExports = exif.exports;
const EXIF = /* @__PURE__ */ getDefaultExportFromCjs(exifExports);
exports.EXIF = EXIF;
